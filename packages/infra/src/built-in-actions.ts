...
const commandRegistry = new Map<string, BuiltInActionCommand>([...fileActionCommands, ...searchActionCommands, ...networkActionCommands, ...processActionCommands].map((command) => [command.definition.id, command]))
