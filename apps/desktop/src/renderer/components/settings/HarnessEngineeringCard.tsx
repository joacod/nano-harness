...
export function HarnessEngineeringCard() {
  return (
    <div className="settings-tab-stack">
      ...
      <FeedbackText>
        Available workflow tools: list_harness_components, propose_harness_change, create_benchmark_run_plan, create_benchmark_run_artifact, write_benchmark_run_artifact, compare_benchmark_results.
      </FeedbackText>
      <FeedbackText>
